...
class LandingController extends Lib\ActionController implements Interfaces\ControllerInterface {
  ...
  public function execute() {
	...
	$cache_item = $this->cache_pool->getItem('landing_' . $this->ajax);

	if($cache_item->isMiss()) {

		$cache_item->lock();

		$template = $this->twig->loadTemplate('landing.html');
